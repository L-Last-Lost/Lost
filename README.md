...
# 运行
![[kid/Pasted image 20250511151840.png]]
![[kid/Pasted image 20250511151937.png]]
![[kid/Pasted image 20250511151628.png]]
![[kid/Pasted image 20250511151709.png]]
# Entity
作为玩家和敌人的基类
...
![[kid/Pasted image 20250511222547.png|500]]
## 连续攻击
...
![[kid/Pasted image 20250512144533.png|450]]
## 落地攻击
...
![[kid/Pasted image 20250511222505.png|398]]
## 攻击硬值
...
![[kid/Pasted image 20250511221443.png|500]]
...
![[kid/Pasted image 20250511222435.png|500]]
## 黑洞
...
![[kid/Pasted image 20250511221759.png|500]]
## 水晶
...
![[kid/Pasted image 20250511221828.png|475]]
![[kid/Pasted image 20250512134057.png|475]]
# 敌人
## 敌人状态机
通过状态机来完成敌人不同行为直接的变换,
状态机通过状态和状态的保存来完成
...
## 骷髅
最简单的生物, 没什么好说的
![[kid/Pasted image 20250511221901.png|500]]
## 史莱姆
**通过enum实现大生中, 中生小**
...
![[kid/Pasted image 20250511222249.png|417]]
## 弓箭手
### 箭
0重力, 碰撞检测连续CollisionDetection Continuous
**拖尾特效用particle**做, 勾选Trails ![[kid/Pasted image 20250511102757.png|166]]
...
![[kid/Pasted image 20250512134659.png|500]]
# 状态Stat
## 数值基类Stat
...
![[kid/Pasted image 20250512134147.png|329]]
## 给黑洞加上特效
...
可以用这种微小的粒子效果来指引玩家
![[kid/Pasted image 20250511233106.png|400]]
## 攻击特效
...
![[kid/Pasted image 20250512134925.png|400]]
## 灰尘特效
用effect particle
...
![[kid/Pasted image 20250511232910.png|486]]
# 装备
## 物品 
我们用ItemData来抽象
...
Canvas belike: ![[kid/Pasted image 20250507211511.png|139]]
...
### 内容
ui-image + ui-text ![[kid/Pasted image 20250507111627.png|97]], 只会拉伸绿色框中的内容, 可以用XY坐标来对齐
### 属性
两个ui-text, 一个左对齐一个右对齐, 子要跟父同拉伸 ![[kid/Pasted image 20250507113255.png|78]] (设置Raycast Target为空即可以取消它的点击框, image中)

创建UI脚本, 放到Canvas上, 把每个按钮的onClick加上脚本
![[kid/Pasted image 20250507111117.png|401]]
...
![[kid/Pasted image 20250507144917.png|102]]
...
**取消BlockRacasts**让鼠标可以**透过某个界面进行点击**, 比如说Tip界面 ![[kid/Pasted image 20250507230703.png|433]]
## 制作页面
...
![[kid/Pasted image 20250507163111.png|300]] ![[kid/Pasted image 20250507163135.png|267]] ![[kid/Pasted image 20250507163537.png|315]]
## 技能树
怎么做UI就不说了
...
## 设置界面
Slide就可以制作一个滑动设置的玩意
toggle就可以制作一个选项, 用背景即可, 加上onValueChanged ![[kid/Pasted image 20250507220358.png|325]] 就可以实现切换
## 类似黑魂卢恩的UI
...
![[kid/Pasted image 20250511222806.png|500]]
# 保存系统
## SaveManager实现原理
...
![[kid/Pasted image 20250511222705.png|475]]
# 检查点
...
```
![[kid/Pasted image 20250511222226.png|500]]
